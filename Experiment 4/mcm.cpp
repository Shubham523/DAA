...
{ 
    ...
    {
        cout << "("; printOptimalParenthesis(s, i, s[i][j]); printOptimalParenthesis(s, s[i][j]+1, j); cout << ")";
    }
...
{ 
    ...
    cout << "\nOptimal Parenthesization: "; printOptimalParenthesis(s, 1, n);
    cout << endl;

    cout << "\nMinimum Number of Scalar Multiplications: " << m[1][n] << endl; 
    cout << "\n\nm table:";
    for(int a = 0; a < 8; a++)
